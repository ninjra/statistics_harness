...
from plugins.analysis_red_flags_refined_v1.plugin import Plugin
...
def test_analysis_red_flags_refined_v1_smoke(run_dir) -> None:
    ctx = make_openplanter_context(run_dir, run_seed=12)
