import numpy as np
import pandas as pd
from plugins.analysis_inverse_propensity_weighting_v1.plugin import Plugin
from tests.conftest import make_context


def test_ipw_estimates_ate(run_dir):
...
def test_ipw_skips_empty_dataframe(run_dir):
