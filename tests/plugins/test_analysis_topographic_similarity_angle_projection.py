...
from plugins.analysis_topographic_similarity_angle_projection.plugin import Plugin
...
def test_analysis_topographic_similarity_angle_projection_smoke(run_dir):
    df = _sample_df()
