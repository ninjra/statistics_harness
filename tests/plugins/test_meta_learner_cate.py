...
import pandas as pd
import pytest
from plugins.analysis_meta_learner_cate_v1.plugin import Plugin
from tests.conftest import make_context


def test_meta_learner_cate_smoke(run_dir):
    ...
    if result.status == "ok":
        ...
        assert "cate_std" in result.findings[0]


def test_meta_learner_cate_skips_empty_dataframe(run_dir):
