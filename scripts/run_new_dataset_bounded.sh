...
export STAT_HARNESS_ENABLE_TOPO_TDA="${STAT_HARNESS_ENABLE_TOPO_TDA:-1}"
export STAT_HARNESS_PLANNER_INCLUDE_UNTAGGED="${STAT_HARNESS_PLANNER_INCLUDE_UNTAGGED:-1}"
